...
import os
os.makedirs("data_total_params_const_test", exist_ok=True)

# Output file for metrics
metrics_file = open("data_total_params_const_test/metrics_summary.txt", "w")
...
for feature, hl in configs:
    ...
    np.savetxt(f"data_total_params_const_test/training_history_F{feature}_HL{hl}.csv", hist, delimiter=",", header="Total,PDE,Consistency,Initial,Boundary", comments="")
    ...
    plt.savefig(f"data_total_params_const_test/training_loss_F{feature}_HL{hl}.png", bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"data_total_params_const_test/solutions_F{feature}_HL{hl}.png", bbox_inches='tight')
    plt.close()
...
plt.savefig("data_total_params_const_test/rmse_vs_ratio.png", bbox_inches='tight')
plt.close()

print("\nAll iterations completed. Metrics and plots saved to the 'data_total_params_const_test' folder.")
# %%
