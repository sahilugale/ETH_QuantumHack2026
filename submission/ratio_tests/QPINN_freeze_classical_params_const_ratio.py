...
for seed in seeds:
    ...
    base_folder = f"data_class_params_const_frozen_test_seed_{seed}"
...
plt.title('Mean RMSE across Seeds with Standard Deviation\n(Classical Params Const Ratio - Frozen Quantum)')
plt.xticks(x_pos, labels)
plt.grid(axis='y', linestyle='--', alpha=0.7)

plt.tight_layout()
# Appended _frozen to the file name
plt.savefig("aggregated_rmse_classical_params_const_ratio_frozen.png", dpi=300)
plt.show()

print("Aggregated plot saved as 'aggregated_rmse_classical_params_const_ratio_frozen.png'.")